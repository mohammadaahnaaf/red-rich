...
export function PinIcon(props: Props) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={props.style}>
...
export function FbIcon(props: Props) {
    return (
        <svg
            className={props.style}
...
export function TwIcon(props: Props) {
    return (
        <svg
            className={props.style}
            xmlns="http://www.w3.org/2000/svg"
